 ...
 * @author mutsu
 */
public class ProveedoresReporte extends HttpServlet {
  private Conexion cn;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        OutputStream out =response.getOutputStream();
         ...
         try{
             ...
             try {
                  ...
                  cn = new Conexion();
            String query = "Select idProveedor,proveedor,NIT,direccion,telefono from proveedores order by idProveedor;";
            cn.abrir_conexion();
        ...
        System.out.println(timeStamp); 
            ...
            documento.add(fecha1); 
             ...
             par1.add(new Phrase("REPORTE PROVEEDORES",fonttitulo));
             ...
             PdfPCell celda1 = new PdfPCell (new Paragraph("No",FontFactory.getFont("Arial", 12, Font.BOLD,BaseColor.WHITE)));
             PdfPCell celda2 = new PdfPCell (new Paragraph("Proveedor",FontFactory.getFont("Arial", 12, Font.BOLD,BaseColor.WHITE)));
             PdfPCell celda3 = new PdfPCell (new Paragraph("NIT",FontFactory.getFont("Arial", 12, Font.BOLD,BaseColor.WHITE)));
             PdfPCell celda4 = new PdfPCell (new Paragraph("Direccion",FontFactory.getFont("Arial", 12, Font.BOLD,BaseColor.WHITE)));
             PdfPCell celda5 = new PdfPCell (new Paragraph("Telefono",FontFactory.getFont("Arial", 12, Font.BOLD,BaseColor.WHITE)));
